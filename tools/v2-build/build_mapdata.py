...
MAP_LABEL_SHORT = {
    ...
    # 2026-08-08: 名前の置き場を「横1つ×縦3つ」に統一した分、長い名前は入らなくなった。
    # 8.5m しか離れていない店が5組あり、その並びで名前ごと消えていたもの。
    '中華レストラン とらの子': 'とらの子',
    'ん daccha とこや': 'ん daccha',
    '左官職人早坂組': '早坂組',
    '中山鍼灸接骨院': '中山鍼灸',
    'スクールIE 仙台中山校': 'スクールIE',
    '東北電力研究開発センター': '東北電力',
    '中山ドライブスクール': '中山ドライブ',
    'ヨークベニマル 仙台中山店': 'ヨークベニマル',
    'BURB usedclothing': 'BURB',
    '中山鳥瀧不動尊（目の神様）': '目の神様',
    'なかやまとびのこ公園': 'とびのこ公園',
    '商店街モニュメント': 'モニュメント',
    # 2026-08-08 実測: 縮尺を 1.45〜3.00 まで振っても一度も名前が出ない店が3件あった。
    # うち2件は「隣が近い」のではなく「名前が長くて、置く枠がバス通りの塗りをまたぐ」のが原因
    # (七十七銀行はいちばん近い店まで35m あるのに、9文字の枠が道路と隣の印まで届いていた)。
    '七十七銀行中山支店': '七十七銀行',
    '中山の坂の上': '坂の上',
}
OFFICIAL_URL_FIX = {
